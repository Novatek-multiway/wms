...
function Shelf(props: IShelf) {
	...
	return (
		<group>
			{rackList && rackList.map((pos, index) => <mesh key={index} position={pos} geometry={rackGeometry} material={shelfMat} />)}
			{planeList &&
				planeList.map((pos, index) => <mesh key={index} position={pos} geometry={planeGeometry} material={shelfMat} />)}
			{colPlaneList && colPlaneList.map((pos, index) => <mesh key={index} position={pos} geometry={colPlaneGeometry} material={shelfMat} />)}
		</group>
	);
}
