declare class Hammer {
  constructor(ref: any | null, options: any);
  get(re: string): Hammer;
  set(options: any);
}
...
declare namespace API {
  ...
  type getPadContainerInventoryEmptyTrayBindingByCodeParams = {
    locationCode?: string;
    trayCode?: string;
  };

  type getPadContainerInventoryEmptyTrayBindingByTypeParams = {
    locationCode?: string;
    trayTypeId?: number;
  };
  ...
  type getPadInboundGetInventoryParams = {
    /** 位置编号 */
    locationCode?: string;
    /** 容器编号 */
    containerCode?: string;
  ...
  type getPadIndexOutStockConfirmParams = {
    /** 出库位置 */
    locationCode?: string;
    /** 容器编号，可空 */
    containerCode?: string;
  ...
  type OutputRowShelvesDTOListR = {
    /** 接口执行结果是否成功 */
    success?: boolean;
    /** 接口执行结果信息（一般执行异常返回异常消息） */
    message?: string;
    /** 接口执行结果数据 */
    resultData?: OutputRowShelvesDTO[];
    statusCode?: EnumStatusCode;
  };
